(() => {
    ...
    $(".menu-header__icon").click((function(event) {
        ...
        if ($(this).hasClass("active")) $("body").data("scroll", $(window).scrollTop());
        $("body").toggleClass("lock");
        if (!$(this).hasClass("active")) $("body,html").scrollTop(parseInt($("body").data("scroll")));
    }));
    //!вставка карта
        function map(n) {
        ...
        for (var i = 0; i < locations.length; i++) {
            ...
            google.maps.event.addListener(marker, "click", function(marker, i) {
                return function() {
                    for (var m = 0; m < markers.length; m++) markers[m].setIcon(icon);
                    var cnt = i + 1;
